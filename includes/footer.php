    ...
    <div class="mobile-conversion-bar" aria-label="Hızlı iletişim">
        <a href="https://wa.me/<?= e(CONTACT_WHATSAPP_E164); ?>?text=Merhaba%2C%20kurumsal%20k%C4%B1rtasiye%20teklifi%20almak%20istiyorum." target="_blank" rel="noopener" data-track="whatsapp_click">WhatsApp</a>
        <a href="<?= e(url('teklif-al')); ?>">Teklif Al</a>
    </div>

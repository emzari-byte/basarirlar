    ...
    <footer class="site-footer">
        <div class="container footer-cta">
            <div>
                <p class="eyebrow">Kurumsal teklif</p>
                <h2>Ürün listenizi gönderin, faturalı teklif sürecini başlatalım.</h2>
            </div>
            <div class="cta-actions cta-actions--light">
                <a class="btn btn--light" href="<?= e(url('teklif-al')); ?>" data-track="category_quote_click" data-category="footer">Kurumsal Teklif Alın</a>
                <a class="btn btn--outline" href="https://wa.me/<?= e(CONTACT_WHATSAPP_E164); ?>?text=<?= e(rawurlencode('Merhaba, kurumsal kırtasiye ürün listemi paylaşıp teklif almak istiyorum.')); ?>" target="_blank" rel="noopener" data-track="whatsapp_click">WhatsApp'tan Liste Gönderin</a>
            </div>
        </div>
        <div class="container footer-grid">
            <div class="footer-brand">
                <img src="<?= e(asset('images/basarirlar-logo.png')); ?>" alt="<?= e(SITE_NAME); ?>" width="750" height="182">
                <p>Şirketler, kamu kurumları ve sanayi işletmeleri için 10.000+ ürün, 100+ marka, toptan fiyat ve şehir içi servis destekli kurumsal kırtasiye tedariği.</p>
            </div>
            <div>
                <h2>Sayfalar</h2>
            ...
            <div>
                ...
                <ul class="footer-links">
                    ...
                    <li><a href="<?= e(url('urun-gruplari/toner-kartus')); ?>">Toner & Kartuş</a></li>
                    <li><a href="<?= e(url('urun-gruplari/dosyalama-urunleri')); ?>">Dosyalama</a></li>
            ...
            <div>
                ...
                <address>
                    ...
                    <a href="tel:+902582634567" data-track="phone_click"><?= e(CONTACT_PHONE); ?></a><br>
                    <a href="tel:+<?= e(CONTACT_WHATSAPP_E164); ?>" data-track="phone_click"><?= e(CONTACT_WHATSAPP); ?></a><br>
    ...
    <div class="cookie-bar" data-cookie-bar hidden>
        <p>Zorunlu çerezler siteyi çalıştırır. Google Analytics yalnızca izninizle yüklenir. Ayrıntılar: <a href="<?= e(url('cerez-politikasi')); ?>">Çerez Politikası</a></p>
        <div class="cookie-actions">
            <button type="button" class="btn btn--light" data-cookie-reject>Reddet</button>
            <button type="button" class="btn" data-cookie-accept>Kabul Et</button>
        </div>
    </div>
    <div class="mobile-conversion-bar" aria-label="Hızlı iletişim">
        <a href="https://wa.me/<?= e(CONTACT_WHATSAPP_E164); ?>?text=<?= e(rawurlencode('Merhaba, kurumsal kırtasiye ürün listemi paylaşıp teklif almak istiyorum.')); ?>" target="_blank" rel="noopener" data-track="whatsapp_click" aria-label="WhatsApp üzerinden ürün listesi gönder">WhatsApp</a>
        <a href="<?= e(url('teklif-al')); ?>" data-track="category_quote_click" data-category="mobile_sticky" aria-label="Kurumsal teklif formuna git">Teklif Al</a>
    </div>
    <a class="whatsapp-float" href="https://wa.me/<?= e(CONTACT_WHATSAPP_E164); ?>?text=Merhaba%2C%20kurumsal%20k%C4%B1rtasiye%20teklifi%20almak%20istiyorum." target="_blank" rel="noopener" aria-label="WhatsApp ile yazın" data-track="whatsapp_click">

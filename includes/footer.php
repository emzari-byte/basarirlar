    ...
    <div class="mobile-conversion-bar" aria-label="Hızlı iletişim">
        <a href="https://wa.me/<?= e(CONTACT_WHATSAPP_E164); ?>?text=Merhaba%2C%20%C3%BCr%C3%BCn%20listemi%20payla%C5%9F%C4%B1p%20kurumsal%20teklif%20almak%20istiyorum." target="_blank" rel="noopener" data-track="whatsapp_click">WhatsApp</a>
        <a href="<?= e(url('teklif-al')); ?>">Liste Yükle</a>
    </div>
